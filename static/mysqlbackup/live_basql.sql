...
(
        21,
        'Can add diagnostic centre registration',
        6,
        'add_diagnosticcentreregistration'
    ),
(
        22,
        'Can change diagnostic centre registration',
        6,
        'change_diagnosticcentreregistration'
    ),
(
        23,
        'Can delete diagnostic centre registration',
        6,
        'delete_diagnosticcentreregistration'
    ),
(
        24,
        'Can view diagnostic centre registration',
        6,
        'view_diagnosticcentreregistration'
    ),
(
        25,
        'Can add doctor registration',
        7,
        'add_doctorregistration'
    ),
(
        26,
        'Can change doctor registration',
        7,
        'change_doctorregistration'
    ),
(
        27,
        'Can delete doctor registration',
        7,
        'delete_doctorregistration'
    ),
(
        28,
        'Can view doctor registration',
        7,
        'view_doctorregistration'
    ),
(
        29,
        'Can add hospital and nursing home registration',
        8,
        'add_hospitalandnursinghomeregistration'
    ),
(
        30,
        'Can change hospital and nursing home registration',
        8,
        'change_hospitalandnursinghomeregistration'
    ),
(
        31,
        'Can delete hospital and nursing home registration',
        8,
        'delete_hospitalandnursinghomeregistration'
    ),
(
        32,
        'Can view hospital and nursing home registration',
        8,
        'view_hospitalandnursinghomeregistration'
    ),
(
        33,
        'Can add payment forms dtails model',
        9,
        'add_paymentformsdtailsmodel'
    ),
(
        34,
        'Can change payment forms dtails model',
        9,
        'change_paymentformsdtailsmodel'
    ),
(
        35,
        'Can delete payment forms dtails model',
        9,
        'delete_paymentformsdtailsmodel'
    ),
(
        36,
        'Can view payment forms dtails model',
        9,
        'view_paymentformsdtailsmodel'
    ),
...
(
        41,
        'Can add payment table multi row model',
        11,
        'add_paymenttablemultirowmodel'
    ),
(
        42,
        'Can change payment table multi row model',
        11,
        'change_paymenttablemultirowmodel'
    ),
(
        43,
        'Can delete payment table multi row model',
        11,
        'delete_paymenttablemultirowmodel'
    ),
(
        44,
        'Can view payment table multi row model',
        11,
        'view_paymenttablemultirowmodel'
    ),
...
(
        49,
        'Can add appointment model',
        13,
        'add_appointmentmodel'
    ),
(
        50,
        'Can change appointment model',
        13,
        'change_appointmentmodel'
    ),
(
        51,
        'Can delete appointment model',
        13,
        'delete_appointmentmodel'
    ),
(
        52,
        'Can view appointment model',
        13,
        'view_appointmentmodel'
    ),
(
        53,
        'Can add policy details model',
        14,
        'add_policydetailsmodel'
    ),
(
        54,
        'Can change policy details model',
        14,
        'change_policydetailsmodel'
    ),
(
        55,
        'Can delete policy details model',
        14,
        'delete_policydetailsmodel'
    ),
(
        56,
        'Can view policy details model',
        14,
        'view_policydetailsmodel'
    );
...
VALUES (
        ...
        'contenttypes',
        '0001_initial',
        '2025-01-15 04:44:52.860357'
    ),
(
        2,
        'contenttypes',
        '0002_remove_content_type_name',
        '2025-01-15 04:44:52.966968'
    ),
(
        3,
        'auth',
        '0001_initial',
        '2025-01-15 04:44:53.505329'
    ),
(
        4,
        'auth',
        '0002_alter_permission_name_max_length',
        '2025-01-15 04:44:53.615503'
    ),
(
        5,
        'auth',
        '0003_alter_user_email_max_length',
        '2025-01-15 04:44:53.623528'
    ),
(
        6,
        'auth',
        '0004_alter_user_username_opts',
        '2025-01-15 04:44:53.632703'
    ),
(
        7,
        'auth',
        '0005_alter_user_last_login_null',
        '2025-01-15 04:44:53.641794'
    ),
(
        8,
        'auth',
        '0006_require_contenttypes_0002',
        '2025-01-15 04:44:53.646791'
    ),
(
        9,
        'auth',
        '0007_alter_validators_add_error_messages',
        '2025-01-15 04:44:53.655164'
    ),
(
        10,
        'auth',
        '0008_alter_user_username_max_length',
        '2025-01-15 04:44:53.663923'
    ),
(
        11,
        'auth',
        '0009_alter_user_last_name_max_length',
        '2025-01-15 04:44:53.671956'
    ),
(
        12,
        'auth',
        '0010_alter_group_name_max_length',
        '2025-01-15 04:44:53.682794'
    ),
(
        13,
        'auth',
        '0011_update_proxy_permissions',
        '2025-01-15 04:44:53.693546'
    ),
(
        14,
        'auth',
        '0012_alter_user_first_name_max_length',
        '2025-01-15 04:44:53.710489'
    ),
(
        15,
        'tplcapp',
        '0001_initial',
        '2025-01-15 04:44:54.557506'
    ),
(
        16,
        'admin',
        '0001_initial',
        '2025-01-15 04:44:54.794190'
    ),
(
        17,
        'admin',
        '0002_logentry_remove_auto_add',
        '2025-01-15 04:44:54.802956'
    ),
(
        18,
        'admin',
        '0003_logentry_add_action_flag_choices',
        '2025-01-15 04:44:54.812805'
    ),
(
        19,
        'sessions',
        '0001_initial',
        '2025-01-15 04:44:54.859889'
    ),
(
        20,
        'tplcapp',
        '0002_leadmodel_alter_customuser_table',
        '2025-01-15 04:44:54.967443'
    ),
(
        21,
        'tplcapp',
        '0003_appointmentmodel_policydetailsmodel_customuser_area',
        '2025-01-15 04:44:55.044900'
    ),
(
        22,
        'tplcapp',
        '0004_alter_policydetailsmodel_options_and_more',
        '2025-01-15 04:44:55.085042'
    );
...
VALUES (
        '2biin6bwpb36cyg5vfvz8ljdrv0119c6',
        '.eJxVjMsOwiAQRf-FtSHMlPBw6d5vIAwMUjWQlHZl_Hdt0oVu7znnvkSI21rDNngJcxZnAeL0u1FMD247yPfYbl2m3tZlJrkr8qBDXnvm5-Vw_w5qHPVbowE7sSOasESF2SsqQNmRnrTzGC17jYkYjDFsUkGwTIq8Bqs0KCfeH92nN2U:1tZmg0:MbNxU8cKCpyDGynfNMOzqnP3At9WUpcGYOvw20WzEQg',
        '2025-02-03 07:58:28.426688'
    ),
(
        '5iiijpi2ouci2k93asrd78nc7z2bb37g',
        '.eJxVjEEOwiAQRe_C2hCYFoa4dO8ZyMCAVA1NSrtqvLs06UK37_33d-FpW4vfWlr8xOIqQFx-WaD4SvUQ_KT6mGWc67pMQR4Tedom7zOn9-3c_h0UaqXXQQGD1RAsOuOQwajRBMdmGFPihEGTzVoNGVXsIEZtMHcBPcxIID5f2SE4Uw:1tZNHD:PkTROS7CWw9ltph466201KkEASNgE0WPx326wfHBXkA',
        '2025-02-02 04:51:11.386332'
    ),
(
        'vbzl0gxk9eb963kliwyscq0lkezc4z6p',
        '.eJxVjEEOwiAQRe_C2hCYFoa4dO8ZyMCAVA1NSrtqvLs06UK37_33d-FpW4vfWlr8xOIqQFx-WaD4SvUQ_KT6mGWc67pMQR4Tedom7zOn9-3c_h0UaqXXQQGD1RAsOuOQwajRBMdmGFPihEGTzVoNGVXsIEZtMHcBPcxIID5f2SE4Uw:1tYlYy:dQq4-2p1OP1akh6rPc1TVHdBNhfxUgnithOisY3tygw',
        '2025-01-31 12:35:00.574646'
    ),
(
        'wo1wpj052l64ksl0mzyq5rzw5k95u73x',
        '.eJxVjMsOwiAQRf-FtSHMlPBw6d5vIAwMUjWQlHZl_Hdt0oVu7znnvkSI21rDNngJcxZnAeL0u1FMD247yPfYbl2m3tZlJrkr8qBDXnvm5-Vw_w5qHPVbowE7sSOasESF2SsqQNmRnrTzGC17jYkYjDFsUkGwTIq8Bqs0KCfeH92nN2U:1tZjiS:9PH7WhaFTmhTa3yr7vYWa3bFaYV79cqPM5l5uGHPGCY',
        '2025-02-03 04:48:48.211367'
    ),
(
        'ypjugrddsnmciihnf4fz6cjobrqyf4is',
        '.eJxVjEEOwiAQRe_C2hCYFoa4dO8ZyMCAVA1NSrtqvLs06UK37_33d-FpW4vfWlr8xOIqQFx-WaD4SvUQ_KT6mGWc67pMQR4Tedom7zOn9-3c_h0UaqXXQQGD1RAsOuOQwajRBMdmGFPihEGTzVoNGVXsIEZtMHcBPcxIID5f2SE4Uw:1tYea7:Ggel88KguxbUm9v1Hu6xUpPLZFTmBVnXlMN_uPtXGJs',
        '2025-01-31 05:07:43.882747'
    );
...
;
INSERT INTO `tbl_doctor_registration`
VALUES (
        1,
        'Amos Nguyen',
        'Modi sit quia sed et dicta dolor dolorem iure',
        'Qui totam in cupidatat eveniet sint impedit ad consequatur expedita ullam sint minima ut beatae totam',
        'Ducimus deleniti labore earum nihil provident',
        'Magna nostrud qui fuga Porro blanditiis dolor cupidatat sit consequat Similique',
        59,
        'Sequi occaecat irure quia sed dolore fugiat magna non unde eum sequi ea id ut',
        'Et consequatur quia est facere quo ratione suscipit',
        'Ea reprehenderit quia sunt amet alias corporis non quis ullam ipsam',
        'Qui placeat sit eaque commodo tempora fuga Perferendis non iste qui qui nobis',
        25,
        '627',
        '771',
        'budaz@mailinator.com',
        '1982-05-15',
        '2023-12-28',
        'PAN',
        '35',
        'CHEST & TURBERCULOSIS SPECIALIST',
        'Est non quo incididunt sed ea id tempora quos ut irure',
        'Incidunt aliquip sed quidem cupiditate sunt tempor voluptas accusamus quod ducimus molestias nostrud inventore saepe soluta culpa qui voluptas ut',
        '668',
        2012,
        'Est ullam in adipisci et',
        'Yes',
        'Desiree Irwin',
        'Vel',
        28,
        ...
        'Yes',
        '40 Lakh',
        'Velit dolores occaecat sapiente fugit dolore in cillum omnis et illum temporibus',
        'Autem est eius laboriosam beatae officia sapiente repellendus Voluptatem explicabo Proident facilis nulla inventore ut consectetur',
        'Yuli Yang',
        'koboxys@mailinator.com',
        46,
        'Eu ea est asperiores maxime placeat sit eius voluptate voluptatum nihil laudantium iusto quas cillum occaecat earum asperiores',
        _binary 'documents/popular_image56.jpg',
        'images/popular_image11.jpg',
        'signatures/popular_image102.jpg',
        '2020-05-26 04:40:00.000000',
        'Commodo vitae ut libero asperiores voluptatem rem voluptatem et est optio dolore velit voluptatem',
        'TPD001000',
        '2025-01-16 04:48:32.782664',
        '2025-01-16 04:48:32.905724',
        1
    ),
(
        2,
        'SUNIL KUMAR',
        'S/O BALIRAM SINGH GIRIJA NIWAS',
        '99 BESIDE MISSION HOSPITAL PREM NAGAR LATMA ROAD HATIA RANCHI',
        'RANCHI',
        'Jharkhand',
        834003,
        'NA',
        ...
        '03 YEAR',
        'ASHOK MISHRA',
        'ashokmishra@truepathlegalconsultant.com',
        23994,
        'CQ NO 307608 DATE 16.01.2025 state bankof india',
        _binary 'documents/WhatsApp_Image_2025-01-15_at_19.09.04.jpeg',
        '',
        '',
        '2025-01-16 10:55:00.000000',
        'RANCHI',
        'TPD001001',
        '2025-01-16 05:26:37.947133',
        '2025-01-16 05:26:37.961787',
        2
    ),
(
        3,
        'MD ABID AKHTAR',
        'S/O MD ALI R ALI BUILDING MAIN ROAD RANCHI',
        'ZOHA EYE CARE R ALI BUILDING MULANA AZAD COLONY MAIN ROAD RANCHI',
        'RANCHI',
        'JHARKHAND',
        834001,
        'NA',
        ...
        'ashokmishra@truepathlegalconsultant.com',
        20000,
        'CQ ICICI BANK (000085)',
        _binary 'documents/DR_ABID_AKHTAR.jpg',
        '',
        '',
        '2025-01-17 09:05:00.000000',
        'RANCHI',
        'TPD001002',
        '2025-01-17 05:22:37.036814',
        '2025-01-17 05:22:37.051315',
        2
    );
...
;
INSERT INTO `tbl_hospital_registration`
VALUES (
        1,
        'Vincent Macias',
        'Damon Whitehead',
        ...
        '32',
        'Kylynn Rich',
        'tyrupy@mailinator.com',
        5433,
        '43456FG',
        'registration_certificates/popular_image35.jpg',
        'selfies/popular_image25.jpg',
        'signatures/populkar_image73.jpg',
        '2025-01-11 00:00:00',
        'Ranchi',
        'TPH001000',
        '2025-01-11 10:07:04.009370',
        '2025-01-11 10:07:04.158447',
        1,
        NULL,
        NULL
    ),
(
        ...
        'Ram Dular Singh , Near Durga Mandir Ukrid Ramgarh',
        'Ramgarh , Jharkhand ,',
        'RAMGARH',
        'JHARKHAND',
        825101,
        'Collage Road Opp Panchwati Apartment , Near Ramgarh college',
        'Near Ramgarh college Ramgarh , Jharkhand , 829122',
        'RAMGARH',
        'RAMGARH',
        'JHARKHAND',
        829122,
        ...
        'RANCHI',
        'TPH001001',
        '2025-01-11 15:42:37.589335',
        '2025-01-11 15:42:37.589978',
        1,
        NULL,
        NULL
    );
...
;
INSERT INTO `tbl_payment_form_details`
VALUES (
        1,
        '100000',
        'TPD001001',
        ...
        '',
        '',
        'THREE YEAR LEGAL SERVICES WITH 50 LAH INSURANCE COVER',
        'RANCHI',
        '2025-01-16'
    ),
(
        ...
        '',
        'Eye Surgeon',
        'ZOHA EYE CARE MAHATMA GANDH MAIN ROAD',
        'BEHIND R ALI BUILDING MULANA AZAD COLONY HINDPIRI RANCHI',
        'JHARKHAND',
        'RANCHI',
        '834001',
        '9204344787',
        ...
        '',
        '',
        'legal services 05 year \r\ninsurance 50 lakh for one year',
        'RANCHI',
        '2025-01-17'
    ),
(
        ...
        '',
        '',
        '05 year legal service with \r\ninsurance cover 50 lakh for one year',
        'Ranchi',
        '2025-01-18'
    );
...
;
INSERT INTO `tbl_payment_multi_row_details`
VALUES (
        1,
        'Cheque',
        '',
        ...
        'sbi',
        'Full',
        '2025-01-16 04:33:30.244614',
        '2025-01-16 04:33:30.246604',
        1,
        1
    ),
(
        ...
        'icici bank',
        'Full',
        '2025-01-17 12:46:18.210886',
        '2025-01-17 12:46:18.212842',
        1,
        2
    ),
(
        ...
        'ICICI BANK',
        'Full',
        '2025-01-18 07:16:01.291797',
        '2025-01-18 07:16:01.293562',
        1,
        3
    );
...
;
INSERT INTO `tbl_proposal_extra_details`
VALUES (
        1,
        'Hospital',
        'Chancellor Grant',
...
(
        2,
        1,
        'Pre - Membership Fee / Other Charges',
        '2',
        3.00,
        25.00,
        7.00,
...
VALUES (
        1,
        'pbkdf2_sha256$720000$anHqsvkHCdJiIuUnDyNvKy$Iv0OZrvszTpxN6TZSrL/40e32DU5vO61Ek/yrMcMb1M=',
        1,
        'admin@example.com',
        'Admin',
        1,
        '2025-01-20 07:58:28.424171',
        'Ranchi',
        '2025-01-15 10:28:59.000000',
        'Ranchi'
    ),
(
        2,
        'pbkdf2_sha256$720000$5InBsubXe0N6M8Xpek4IcT$jTVSFO6OKIp6Yd5+sxyNrn18nPRHddznSUoTth01CDo=',
        1,
        'ashokmishra@truepathlegalconsultant.com',
        'Ashok Kumar Mishra',
        1,
        '2025-01-19 04:51:11.381286',
        'Ranchi',
        '2025-01-15 05:07:48.654445',
        'Ranchi'
    );
...
;
-- Dump completed on 2025-01-20 13:01:52